...
<div class="container">
        <div class="mt-3">
            <h1 class="text-center">DATA CARD</h1>
        </div>
<!--------------------------------------------------------------------------------------------------------------------------->
        ...
        <div class="card mt-3">
                ...
                <table class="table table-stripe table-hover">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=$datachar['ttl']?></td>
                            <td>
                                <a href="./aset/view.php?id=<?=$datachar['id']?>" class="btn btn-primary">View</a>
                                <a href="#" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#updata<?= $no ?>">Edit</a>
                                <a href="./aset/delete.php?id=<?=$datachar['id']?>" class="btn btn-danger">Hapus</a>
                            </td>
                        </tr>
            ...
            <div class="modal fade" id="updata<?=$no?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <!--FORM-->
                    <form action="./aset/edit.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="file" value="<?= $datachar['file']?>">
                        </div>
            ...
            <div class="modal fade" id="adddata" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <!--FORM-->
                    <form action="./aset/add.php" method="POST">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">ID CARD</label>
